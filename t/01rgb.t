...
is_deeply( [ $red->rgb8 ], [ 255, 0, 0 ], 'red rgb8' );
is_deeply( [ $red->rgb16 ], [ 0xffff, 0, 0 ], 'red rgb16' );

is( $red->rgb8_hex, 'ff0000', 'red rgb8_hex' );
is( $red->rgb16_hex, 'ffff00000000', 'red rgb16_hex' );
...
is_deeply( [ $green->rgb8 ], [ 0, 255, 0 ], 'green rgb8' );
is_deeply( [ $green->rgb16 ], [ 0, 0xffff, 0 ], 'green rgb16' );

is( $green->rgb8_hex, '00ff00', 'green rgb8_hex' );
is( $green->rgb16_hex, '0000ffff0000', 'green rgb16_hex' );
...
is_deeply( [ $blue->rgb8 ], [ 0, 0, 255 ], 'blue rgb8' );
is_deeply( [ $blue->rgb16 ], [ 0, 0, 0xffff ], 'blue rgb16' );

is( $blue->rgb8_hex, '0000ff', 'blue rgb8_hex' );
is( $blue->rgb16_hex, '00000000ffff', 'blue rgb16_hex' );
...
is_deeply( [ $yellow->rgb8 ], [ 255, 255, 0 ], 'yellow rgb8' );
is_deeply( [ $yellow->rgb16 ], [ 0xffff, 0xffff, 0 ], 'yellow rgb16' );

is( $yellow->rgb8_hex, 'ffff00', 'yellow rgb8_hex' );
is( $yellow->rgb16_hex, 'ffffffff0000', 'yellow rgb16_hex' );
...
is_deeply( [ $cyan->rgb8 ], [ 0, 255, 255 ], 'cyan rgb8' );
is_deeply( [ $cyan->rgb16 ], [ 0, 0xffff, 0xffff ], 'cyan rgb16' );

is( $cyan->rgb8_hex, '00ffff', 'cyan rgb8_hex' );
is( $cyan->rgb16_hex, '0000ffffffff', 'cyan rgb16_hex' );
...
is_deeply( [ $grey->rgb8 ], [ 127, 127, 127 ], 'grey rgb8' );
is_deeply( [ $grey->rgb16 ], [ 0x7fff, 0x7fff, 0x7fff ], 'grey rgb16' );

is( $grey->rgb8_hex, '7f7f7f', 'grey rgb8_hex' );
is( $grey->rgb16_hex, '7fff7fff7fff', 'grey rgb16_hex' );
